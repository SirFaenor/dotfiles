# Convenzioni Filament – treacque.it
...
Esempio reale: `Homepages/HomepageResource.php`, `ProductCategories/ProductCategoryResource.php`
...
class ProductCategory extends Model implements HasMedia
{
    ...
    public function registerMediaCollections(): void
    {
        ...
        $this->addMediaCollection('video_3d')->singleFile();
    }
}
```

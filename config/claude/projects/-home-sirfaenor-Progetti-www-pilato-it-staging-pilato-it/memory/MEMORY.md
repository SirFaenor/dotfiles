# staging.pilato.it – Memoria di progetto

## Stack
- Laravel 12, Filament 4.4
- Spatie MediaLibrary v11, Spatie Translatable v6
- AtrioTeam: filament-helper ^4, lintilla, sitemapgenerator, laravel-deployment
...
## Environment
- PHP gira **dentro il container Docker** `pilato_web`, non sull'host
- Per eseguire comandi: `docker exec pilato_web php artisan ...`
...
- Colonne database sempre in **inglese** — se fornite in italiano, tradurle prima di crearle
